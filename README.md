...
While convenient, our opinion is that this is less educational and does not scale as well to more complex type systems.
...
We present a standard proof based on logical relations, adapted from TaPL.
